...
a persistence unit "javaEE.lab2023PersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/tec/inf/javaEE/lab2023/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "javaEE.lab2023/pom.xml":
...
artifacts ("javaEE.lab2023-ejb.jar" and "javaEE.lab2023-web.war") are already built. You can build
